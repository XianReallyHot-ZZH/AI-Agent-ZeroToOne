...
public class Launcher {
    ...
    private static final Map<String, Class<?>> SESSIONS = Map.ofEntries(
            ...
            Map.entry("s07", S07PermissionSystem.class),
            Map.entry("s08", S08HookSystem.class),
            Map.entry("s09", S09MemorySystem.class),
            Map.entry("s10", S10SystemPrompt.class),
            Map.entry("s11", S11ErrorRecovery.class),
            Map.entry("s12", S12TaskSystem.class),
            Map.entry("s13", S13BackgroundTasks.class),
            Map.entry("s14", S14CronScheduler.class),
            Map.entry("s15", S15AgentTeams.class),
            Map.entry("s16", S16TeamProtocols.class),
            Map.entry("s17", S17AutonomousAgents.class),
            Map.entry("s18", S18WorktreeIsolation.class),
            Map.entry("s19", S19McpPlugin.class),
