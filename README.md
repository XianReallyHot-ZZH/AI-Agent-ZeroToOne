...
| Phase 3: Persistence | s07–s14 | 权限、钩子、记忆、提示词、错误恢复、任务系统、后台执行、定时调度 |
| Phase 4: Teams | s15–s19 | 多 Agent 协作、协议、自治、Worktree 隔离、MCP 插件 |
| Full Agent | SFull | 全量机制整合 |
